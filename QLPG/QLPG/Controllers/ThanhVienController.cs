...
namespace QLPG.Controllers
{
    public class ThanhVienController: Controller
    {
        ...
        private List<string> adminNotifications = new List<string>(); // Danh sách thông báo cho admin
        ...
        public ActionResult ThemDK(ThanhVien tv)
        {
            if (ModelState.IsValid)
            {
                ...
                string adminNotification = $"Hội viên {tv.TenTV} đã đăng ký gói tập {tv.TenGT} vào ngày {tv.NgayTao} với số điện thoại là {tv.SDT}.";
